...
Sample datasets are provided in the `inst/extdata` subdirectory. To load them, 
...
To run the Shiny app for this package and explore the pipeline using its user 
interface, run the following line in your R console.
```{r}
# run_BioTokenizeR()
```
